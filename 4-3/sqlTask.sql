...
--[SELECT store_name AS 店舗名,goods_name AS 商品名,quantity AS 在庫数 FROM stock_table
...
-- [INSERT INTO goods_table (goods_code,goods_name,price,update_day) VALUES ('M001','マフラー',4500,'2022-12-20')]


-- 7. 在庫テーブルの商品コード='S987'、かつ、店舗コード='EA01'に対して、「在庫数=10、更新日付=本日日付」で更新しなさい。※実行後のSELECT結果も貼付すること。
-- [UPDATE stock_table SET quantity=10,update_day='2022-12-20' WHERE goods_code='S987'and store_code='EA01']
