...
public class DBAccess {
    ...
    private static final String PASS ="Acepilot";
    public static void main(String[] args) {
    	...
    	try {
			...
			while(resultSet.next()){
				String colum1=resultSet.getString("SHOHIN_ID");
				String colum2=resultSet.getString("SHOHIN_NAME");
				int colum3=resultSet.getInt("TANKA");

				System.out.print(colum1+",");
				System.out.print(colum2+",");
